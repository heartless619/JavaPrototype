 ...
 * With the implemented algorithm, the player tries to stop the other 
 * player making 5 connected pieces without considering player own success for 5-in-a-row.
 * Always defending, no attacking. 
 * 
 * @author Ruixing
 */
...
public class SmartDefender implements Player, Cloneable {
	Piece myPiece;
    String name;
    ...
    public SmartDefender(String name) {
        this.name = name;
    }
        	...
        	for(int i=0;i<SIZE;i++)
        	{
        		for(int j=0;j<SIZE;j++)
        		{
        			...
        			if( board[i][j] == null)
        			{
        				...
        				max_my_piece = checkMaxValue(i,j,board.clone(),getOpponentSide());
